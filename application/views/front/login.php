...
<body>
  <div class="conatiner">
      ...
      ?>
        <form action="<?php echo base_url().'login/authenticate' ;?>" name="loginform" id="loginform" method="POST" class="form-container mx-auto">
          ...
          <p>Not registered? <a href="<?php echo base_url().'singup/index';?>">Sing up</a></p>
        </form>
  </div>
<!-- jQuery library -->
